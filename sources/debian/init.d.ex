...
### BEGIN INIT INFO
# Provides:          sambaedu-client-windows
...
# Author: Denis Bonnenfant <denis.bonnenfant@diderot.org>

DESC="sambaedu-client-windows"
DAEMON=/usr/bin/sambaedu-client-windows
